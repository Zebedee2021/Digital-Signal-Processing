...
subplot(2,1,1)
%h1 = fir1(8,0.3);
h1 = [1 -0.5 1.5 1 2 1 1.5 -0.5 1];%N=9
...
h2 = [1 -0.5 1 1.5 1.5 1 -0.5 1];%N=8
...
h3 = [0.5 -0.5 1 -1 0 1 -1 0.5 -0.5];%N=9
...
h4 = [0.5 -0.5 1 -1 1 -1 0.5 -0.5];%N=8
