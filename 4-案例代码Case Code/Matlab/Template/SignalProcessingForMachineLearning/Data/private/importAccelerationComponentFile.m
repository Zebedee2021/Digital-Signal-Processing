function a_ = importAccelerationComponentFile(filename)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   AZ = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   AZ = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   az = importfile('body_acc_z_train.txt', 1, 7352);
%
%    See also TEXTSCAN.
% 
% Copyright 2014-2015, MathWorks, Inc.

% Auto-generated by MATLAB on 2014/08/12 15:33:46
