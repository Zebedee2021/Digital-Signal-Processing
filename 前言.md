...
<<<<<<< HEAD
[![BIT-LLOGO](https://raw.githubusercontent.com/Zebedee2021/DSP-Book/main/image/bitlogo1.png)](https://bit.edu.cn)
=======
[![BIT-LLOGO](https://github.com/Zebedee2021/DSP-Book/blob/main/image/bitlogo1.png)](https://bit.edu.cn)

>>>>>>> fbc38c5b42f776573832433e42690c2cad74e19c
...
# Matlab程序
### Matlab程序运行步骤
* 安装DSP-Book配套example包
* 拷贝到Matlab/命令行窗口运行
* [BIT zzg dsp chap01.mlx](https://zhiguo-zhou.gitbook.io/dsp/qian-yan)  ![Copy Command](/image/copy_command.png)
* 程序链接可以是参考matlab help编写的html帮助文件
 
# Python程序

### Jupyter Notebook打开
* [BIT zzg dsp chap01.ipynb](http://localhost:8888/tree)
